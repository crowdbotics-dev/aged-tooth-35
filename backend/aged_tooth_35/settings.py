"""
Django settings for aged_tooth_35 project.
...
ROOT_URLCONF = 'aged_tooth_35.urls'
...
WSGI_APPLICATION = 'aged_tooth_35.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "aged_tooth_35 API",
    "DESCRIPTION": "API documentation for aged_tooth_35 App",
    "VERSION": "v1",
}
